...
import com.barbearia.barbearia.application.barbearia.dto.BarbeariaPostDTO;
...
public class BarbeariaController {
    ...
    public ResponseEntity<Barbearia> criar(@RequestBody BarbeariaPostDTO barbeariaPostDTO) {
    	Endereco endereco = enderecoService.buscarEnderecoPorCep(barbeariaPostDTO.cep());

    	Barbearia barbearia = new Barbearia(barbeariaPostDTO.nome(), endereco, barbeariaPostDTO.email(), barbeariaPostDTO.password(), barbeariaPostDTO.telefone());
    ...
    @PostMapping("/cep")
    public ResponseEntity encontrarCEP() {
		return null;
